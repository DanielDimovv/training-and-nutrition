...
import {z} from "zod"
import { GOALS, WORKOUT_TYPES ,DIET_VALUES} from "@/server/db/schema/user_profiles"
...
export function getAuthErrorMessage(code?: string): string {
  switch (code) {
    ...
    case "LOGIN_UPDATE_FAILED":
      return "We couldn't complete the login process. Please try again.";
...
export const userProfileSchema = z.object({
  ...
  workout_types: z.array(workoutTypeEnum).min(1, "Select at least one workout type"),
